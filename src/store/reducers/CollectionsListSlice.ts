import { ICollectionInfo, IResponseError } from '@/types/api';
import { createSlice } from '@reduxjs/toolkit';

type CollectionsState = {
  isLoading: boolean;
  error: IResponseError | undefined;
  collections: ICollectionInfo[] | undefined;
};
...
export const collectionsListSlice = createSlice({
  ...
  initialState,
  reducers: {
    rebootcollectionsListSlice() {
      return initialState;
    },
  },
});

export const collectionsListReducer = collectionsListSlice.reducer;
